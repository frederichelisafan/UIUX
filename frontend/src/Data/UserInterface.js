const UIquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Penggunaan berbagai jenis huruf untuk menambah keunikan.",
        isCorrect: false,
      },
      {
        answerText:
...
const UXquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Menentukan warna dan tipografi yang tepat untuk aplikasi",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Menggunakan prinsip-prinsip desain yang telah ditetapkan",
        isCorrect: true,
      },
    ],
  },
...
const Simplicityquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Dengan mengurangi kompleksitas dan mempercepat pemahaman",
        isCorrect: true,
      },
  ...
  {
    questionText: "Apa yang dimaksud dengan Fokus dalam desain yang sederhana?",
    answerOptions: [
      {
        answerText: "Membuat desain terlihat lebih rumit",
        isCorrect: false,
      ...
      {
        answerText: "Memusatkan perhatian pengguna pada elemen-elemen penting",
        isCorrect: true,
      },
...
const Clarityquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: "Menambahkan lebih banyak elemen dan fitur ke dalam desain",
        isCorrect: false,
      },
      {
        answerText:
  ...
  {
    questionText: "Apa yang dimaksud dengan Informasi yang Jelas dalam desain?",
    answerOptions: [
      {
        answerText:
...
const ClearFeedbackquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Meningkatkan kepuasan pengguna dan mempercepat pemahaman",
        isCorrect: true,
      },
      {
...
const Flexibilityquestions = [
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: "Agar pengguna tidak dapat mengubah apa pun dalam aplikasi",
        isCorrect: false,
      },
      {
        answerText:
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Dengan memberikan pengguna kontrol atas pengalaman mereka",
        isCorrect: true,
      },
      {
        answerText: "Dengan membuat desain lebih kaku dan tidak dapat diubah",
...
const Aestheticquestions = [
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Menampilkan desain yang warnanya mencolok dan berlebihan",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: "Untuk menciptakan desain yang mencolok dan membingungkan",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: "Menambahkan lebih banyak dekorasi visual ke dalam desain",
        isCorrect: false,
      },
      {
        answerText:
...
const ClearFunctionalityquestions = [
  {
    questionText:
